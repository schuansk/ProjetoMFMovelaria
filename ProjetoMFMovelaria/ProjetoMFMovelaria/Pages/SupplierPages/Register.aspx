<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs"
    Inherits="ProjetoMFMovelaria.Pages.SupplierPages.Register" Title="" MasterPageFile="~/Master/Master.Master" %>
                    ...
                    <div class="col-md-10 col-md-offset-1">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <br />
                                <asp:TextBox ID="txtCNPJ" CssClass="cnpj form-control" runat="server" Width="100%"></asp:TextBox>
                                <br />
                    ...
                    <div class="col-md-10 col-md-offset-1">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <br />
                                <asp:DropDownList ID="ddlUf" runat="server" CssClass="form-control" Width="100%">
                    ...
                    <div class="col-md-10 col-md-offset-1">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <br />
                                <asp:TextBox ID="txtAddNumber" CssClass="input-your-tel form-control" runat="server" Width="100%"></asp:TextBox>
                                <br />
